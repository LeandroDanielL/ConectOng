...
class PostPage8 extends StatefulWidget {
  @override
  _PostPage8State createState() => _PostPage8State();
}

class _PostPage8State extends State<PostPage8> {
  int likes = 220;
  bool isLiked = false;
  List<Map<String, String>> comments = [
    {'name': 'Paula Andrade', 'comment': 'Que conquistas maravilhosas!'},
    {'name': 'Ricardo Silva', 'comment': 'Parabéns a todos!'},
    {'name': 'Bianca Costa', 'comment': 'Orgulho de fazer parte!'}
  ];
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          SizedBox(height: 16),
          Text(
            'Para nós, é uma alegria relembrar tudo o que alcançamos no ano passado. Queremos agradecer à comunidade, aos nossos colaboradores e parceiros por todas as vivências e conquistas. Sem cada um de vocês, o Instituto Macunaíma não seria possível. Seguimos juntos!',
            style: TextStyle(
              fontSize: 16,
            ),
          ),
